...
export default [{
  ...
  component: (
    <Alert variant="success">
      <Heading level="h5">Success message</Heading>
  ...
  component: (
    <Alert variant="warning">
      <Heading level="h5">Warning message</Heading>
  ...
  component: (
    <Alert variant="error">
      <Heading level="h5">Error message</Heading>
  ...
  component: (
    <Alert variant="information">
      <Heading level="h5">Information message</Heading>
