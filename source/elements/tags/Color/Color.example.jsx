...
export default [{
  ...
  component: (
    <section>
      ...
      <Heading tagName="h2">Color combinations to test color contrast</Heading>
      <Wrapper size="wide" className="Grid--swatch Color-contrast-test">
        <Color
          variant="swatch"
          colorName="color-shade--00"
          colorValues={[{
