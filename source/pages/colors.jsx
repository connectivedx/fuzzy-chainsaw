      ...
      <SgPageShell__main>
        <SgPageWrapper>
          <Rhythm>
            ...
            <p>
              We run 2 Accessibility tests based on the <Link href="http://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast">WCAG 2.0 contrast ratio formula</Link>. The WCAG 2.0 formula differentiates between text smaller than 18pt/24px, text larger than 18pt (or text that is bold and larger than 14pt/19px).
            </p>
